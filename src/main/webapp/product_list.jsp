...
<style id="style-1-cropbar-clipper">/* Copyright 2018 Evernote Corporation. All rights reserved. */
...
<div id="o-header-2013">
	<div class="w" id="header-2013">
		<div id="logo-2013" class="ld"><a href="http://www.jd.com/" hidefocus="true"><b></b><img src="${pageContext.request.contextPath}/resource/logo-201305.png" width="270" height="60" alt="京东"></a></div>
		<!--logo end-->
		<div id="search-2013">
			<div class="i-search ld">
				<ul id="shelper" class="hide"></ul>
				<form id="actionForm" action="${pageContext.request.contextPath}/jd/queryAll" method="POST">
				<div class="form">
...
<div class="w">
    ...
    <div id="footer-2013">
        ...
        <div class="authentication"><a rel="nofollow" target="_blank" href="http://www.hd315.gov.cn/beian/view.asp?bianhao=010202007080200026"><img width="108" height="40" alt="经营性网站备案中心" src="${pageContext.request.contextPath}/resource/108_40_zZOKnl.gif" class="err-product"></a>
            <a rel="nofollow" target="_blank" tabindex="-1"
				...
				src="${pageContext.request.contextPath}/resource/kxwz.gif"
				class="err-product"></a>
			<a rel="nofollow" target="_blank"
				href="http://www.bj.cyberpolice.cn/index.do"><img width="108"
				height="40" alt="中国警察"
				src="${pageContext.request.contextPath}/resource/cywljc.png"
				class="err-product"></a>
			<a rel="nofollow" target="_blank"
				href="https://search.szfw.org/cert/l/CX20120111001803001836"><img
				width="112" height="40"
				src="${pageContext.request.contextPath}/resource/112_40_WvArIl.png"
				class="err-product"></a>
		</div>
    </div>
</div>
